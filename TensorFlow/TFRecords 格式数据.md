TFRecord格式数据
---
1. 利用TFRecords存储与读取带标签的图片

# 1. TFRecords文件格式
1. TFRecords是一种二进制文件。
2. 优点:可以更好的利用内存，更方便的复制和移动，无需单独标签文件
3. TFRecords文件包含了tf.train.Example协议内存块(protocol buffer)
...
# 2. 参考
1. <a href = "https://blog.csdn.net/u013555719/article/details/77899029">[TFRecord格式数据]利用TFRecords存储与读取带标签的图片</a>